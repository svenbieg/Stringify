...
public:
	...
	// Comparison
	inline bool operator==(SIZE const& Size) { return CompareMemory(this, &Size, sizeof(SIZE))==0; }
	inline bool operator!=(SIZE const& Size) { return CompareMemory(this, &Size, sizeof(SIZE))!=0; }
	...
	inline SIZE Max(SIZE const& Size) { return SIZE(MAX(Width, Size.Width), MAX(Height, Size.Height)); }
